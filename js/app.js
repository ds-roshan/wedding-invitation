...
function updateGuestInfo() {
    ...
    if (eventInfo) {
        eventInfo.style.display = guestData.janti === true ? '' : 'none';
    }
...
function generateCalendar() {
    ...
    const highlightedDate = guestData && guestData.janti === true ? 13 : 14;
...
// ========== COUNTDOWN TIMER ==========
const weddingDate = new Date('2025-02-25 11:30:00').getTime();
...
function initLiveCounter() {
    let viewCount = parseInt(localStorage.getItem('wedding-views-roshan-rabina') || '0');
    viewCount++;
    localStorage.setItem('wedding-views-roshan-rabina', viewCount);
